...
<div class="main-container">
    ...
    <div class="control-panel no-print">
        ...
        <div class="control-group">
            ...
            <button onclick="toggleGroup('details.series-block, details.mono-series-card', 'expand')">↔ Expand All</button>
            <button onclick="toggleGroup('details.series-block, details.mono-series-card', 'collapse')">→ Collapse All</button>
        </div>
        <div class="control-group">
            <span class="control-label">Orders:</span>
            <button onclick="toggleGroup('details.order-row', 'expand')">↔ Expand All</button>
            <button onclick="toggleGroup('details.order-row', 'collapse')">→ Collapse All</button>
        </div>
        <div class="control-group">
            <span class="control-label">Families:</span>
            <button onclick="toggleGroup('details.family-card-collapsible', 'expand')">↔ Expand All</button>
            <button onclick="toggleGroup('details.family-card-collapsible', 'collapse')">→ Collapse All</button>
        </div>
    </div>
...
<script>
    function toggleGroup(selector, action) {{
    ...
    print(f"Success! Generated {family_counter} families with collapsible groups, characters, and batch toggles.")
