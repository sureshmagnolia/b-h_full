...
<div class="main-container">
    <div class="header-main">
        ...
        <div style="font-size: 11px; font-weight: 600; color: #dfe4ea; letter-spacing: 0.5px; margin-top: 2px;">
            Complete Tree of 201 Families | Interactive Collapsible Badges &amp; Groups | Syllabus Families (★) Open by Default
        </div>
    </div>
...
"""
    ...
    order_descriptors = {
        ...
        "Lamiales": "Zygomorphic, drupe/schizocarp, style terminal/gynobasic", "Microspermae": "Inferior ovary, tiny seeds",
        "Epigynae": "Inferior ovary, large endospermic seeds", "Coronariae": "Petaloid perianth, superior ovary",
        "Calycinae": "Sepaloid perianth, superior ovary", "Nudiflorae": "Apetalous, spadix common",
        "Apocarpae": "Superior apocarpous ovary", "Glumaceae": "Flowers enclosed in glumes (scaly bracts)"
    }
...
"""
    ...
    print(f"Success! Generated {family_counter} families with collapsible groups and details.")
