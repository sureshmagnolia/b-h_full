...
<div class="main-container">
    <div class="header-main">
        ...
        <div style="font-size: 11px; font-weight: 600; color: #dfe4ea; letter-spacing: 0.5px; margin-top: 2px;">
            Complete Tree of 201 Families | Interactive Collapsible Badges | Highly Critical Syllabus Families (★) Open by Default
        </div>
    </div>
...
"""
    ...
    print(f"Success! Generated {family_counter} families with collapsible details.")
